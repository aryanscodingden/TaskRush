...
export default function GlassButtonSwitch({
  ...
  const handleClick = (opt: string) => {
    console.log("Button clicked:", opt);
  ...
  return (
    <div className="relative flex bg-white/20 backdrop-blur-xl rounded-xl overflow-hidden p-1 border border-white/30 shadow-lg w-64">
      <motion.div
        className="absolute top-1 bottom-1 w-[calc(50%-4px)] mx-1 rounded-lg bg-white backdrop-blur-md border border-white/30 shadow-[0_0_20px_rgba(255,255,255,0.5)] pointer-events-none"
        animate={{
